...
def run_convergence_check(
    ...
    group_configs = [
        ...
        lambda rng: initialize_from_glasso(N, R_target, K_glasso, all_pairs, target_d=target_d, rng=rng)),
        ("random_init", n_chains_random, n_steps_random,
        lambda rng: initialize_random_uniform(N, R_target, all_pairs, target_d=target_d, rng=rng)),
    ]
...
base_args.save_dir = "./results_geweke_rhat_sparse_factorized_919n20tn20"   
